...
#define LEVEL_UP_TYPE_MOVE(lvl, move, flags) ((lvl << 25) | (move << 16) | flags)
...
/* 
TypeLevelUpLearnsets have the following structure:
[0-N] u32 LEVEL_UP_TYPE_MOVE
[N+1] u32 LEVEL_UP_TYPE_INTERNAL_END
...
LEVEL_UP_TYPE_END

Where each LEVEL_UP_TYPE_INTERNAL_END defines the end to a sub-array of possible moves
learned by a pokemon of the acquired type. A pokemon will learn either 0 or 1 move from
each segment of sub-arrays, depending on whether they match the flags associated with
each move. Order matters here, where the first move that matches will preceed all following
moves. Moves can be repeated within a section to simplify the matching logic.

LEVEL_UP_TYPE_END is used as the array terminator, all values after this are ignored.

Note: I attempted a 3-D array structure previously but had issues with the linker during 
compilation. Fwiw, this format is the more space-effecient (everything can be dynamic length)
and mirrors the format of the other learnset lists that are mon-specific.
*/

static const u32 sNormalTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_SCRATCH, FLAG_HAS_CLAWS), 
    LEVEL_UP_TYPE_MOVE(5, MOVE_POUND, FLAG_ALL_CAN_LEARN), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(9, MOVE_QUICK_ATTACK, FLAG_IS_LIGHT), 
    LEVEL_UP_TYPE_MOVE(9, MOVE_FAKE_OUT, FLAG_ALL_CAN_LEARN), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(18, MOVE_MEGA_PUNCH, FLAG_PHYSICAL_ATTACKER | FLAG_HAS_HANDS), 
    LEVEL_UP_TYPE_MOVE(15, MOVE_COVET, FLAG_PHYSICAL_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(16, MOVE_SWIFT, FLAG_SPECIAL_ATTACKER | FLAG_MIXED_ATTACKER), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(23, MOVE_YAWN, FLAG_IS_ABILITY_1), 
    LEVEL_UP_TYPE_MOVE(21, MOVE_GLARE, FLAG_IS_ABILITY_2), 
    LEVEL_UP_TYPE_MOVE(24, MOVE_SING, FLAG_IS_ABILITY_3), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(32, MOVE_TRI_ATTACK, FLAG_SPECIAL_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(31, MOVE_BODY_SLAM, FLAG_IS_HEAVY), 
    LEVEL_UP_TYPE_MOVE(30, MOVE_SLASH, FLAG_HAS_CLAWS), 
    LEVEL_UP_TYPE_MOVE(29, MOVE_HYPER_FANG, FLAG_HAS_FANGS), 
    LEVEL_UP_TYPE_MOVE(32, MOVE_HYPER_VOICE, FLAG_MIXED_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(32, MOVE_MEGA_KICK, FLAG_HAS_FEET), 
    LEVEL_UP_TYPE_MOVE(31, MOVE_TAKE_DOWN, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(39, MOVE_REFLECT, FLAG_SPECIAL_ATTACKER | FLAG_IS_ABILITY_1 | FLAG_IS_ABILITY_3), 
    LEVEL_UP_TYPE_MOVE(39, MOVE_LIGHT_SCREEN, FLAG_SPECIAL_ATTACKER | FLAG_IS_ABILITY_2), 
    LEVEL_UP_TYPE_MOVE(38, MOVE_TRI_ATTACK, FLAG_MIXED_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(38, MOVE_CRUSH_CLAW, FLAG_HAS_CLAWS), 
    LEVEL_UP_TYPE_MOVE(37, MOVE_SUPER_FANG, FLAG_HAS_FANGS), 
    LEVEL_UP_TYPE_MOVE(38, MOVE_MEDITATE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(44, MOVE_EXTREME_SPEED, FLAG_IS_LIGHT),
    LEVEL_UP_TYPE_MOVE(43, MOVE_UPROAR, FLAG_SPECIAL_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(45, MOVE_DOUBLE_EDGE, FLAG_ALL_CAN_LEARN), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(52, MOVE_THRASH, FLAG_PHYSICAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(52, MOVE_THRASH, FLAG_MIXED_ATTACKER | FLAG_IS_ABILITY_2 | FLAG_IS_ABILITY_3),
    LEVEL_UP_TYPE_MOVE(51, MOVE_RECOVER, FLAG_IS_ABILITY_1),
    LEVEL_UP_TYPE_MOVE(53, MOVE_WISH, FLAG_IS_ABILITY_2),
    LEVEL_UP_TYPE_MOVE(52, MOVE_HEAL_BELL, FLAG_IS_ABILITY_3),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(60, MOVE_HYPER_BEAM, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(60, MOVE_GIGA_IMPACT, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

/*
static const u32 Fighting4[] = {
    elemental punches based on ability?
    LEVEL_UP_TYPE_MOVE(41, MOVE_BULK_UP),
    LEVEL_UP_TYPE_MOVE(45, MOVE_DRAIN_PUNCH),
    LEVEL_UP_TYPE_MOVE(50, MOVE_CROSS_CHOP),
    LEVEL_UP_TYPE_MOVE(54, MOVE_FOCUS_BLAST),
    LEVEL_UP_TYPE_MOVE(60, MOVE_CLOSE_COMBAT),
    LEVEL_UP_TYPE_MOVE(70, MOVE_SUPERPOWER),
}
*/

static const u32 sFightingTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(6, MOVE_LOW_KICK, FLAG_HAS_FEET), 
    LEVEL_UP_TYPE_MOVE(5, MOVE_DOUBLE_SLAP, FLAG_HAS_HANDS),
    LEVEL_UP_TYPE_MOVE(4, MOVE_MEDITATE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(8, MOVE_VACUUM_WAVE, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(9, MOVE_MACH_PUNCH, FLAG_HAS_HANDS), 
    LEVEL_UP_TYPE_MOVE(8, MOVE_VACUUM_WAVE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(15, MOVE_KARATE_CHOP, FLAG_HAS_HANDS),
    LEVEL_UP_TYPE_MOVE(14, MOVE_DOUBLE_KICK, FLAG_HAS_FEET), 
    LEVEL_UP_TYPE_MOVE(15, MOVE_SWIFT, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(25, MOVE_AURA_SPHERE, FLAG_SPECIAL_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(23, MOVE_FORCE_PALM, FLAG_ALL_CAN_LEARN), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(30, MOVE_AURA_SPHERE, FLAG_MIXED_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(28, MOVE_SEISMIC_TOSS, FLAG_ALL_CAN_LEARN), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(34, MOVE_FIRE_PUNCH, FLAG_IS_ABILITY_1 | FLAG_HAS_HANDS), 
    LEVEL_UP_TYPE_MOVE(34, MOVE_THUNDER_PUNCH, FLAG_IS_ABILITY_2 | FLAG_HAS_HANDS), 
    LEVEL_UP_TYPE_MOVE(34, MOVE_ICE_PUNCH, FLAG_IS_ABILITY_3 | FLAG_HAS_HANDS),
    LEVEL_UP_TYPE_MOVE(34, MOVE_GRASS_KNOT, FLAG_SPECIAL_ATTACKER | FLAG_MIXED_ATTACKER),
    LEVEL_UP_TYPE_MOVE(34, MOVE_JUMP_KICK, FLAG_HAS_FEET),
    LEVEL_UP_TYPE_MOVE(34, MOVE_BODY_SLAM, FLAG_ALL_CAN_LEARN), 
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(39, MOVE_AURA_SPHERE, FLAG_SPECIAL_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(39, MOVE_DRAIN_PUNCH, FLAG_HAS_HANDS),
    LEVEL_UP_TYPE_MOVE(39, MOVE_AURA_SPHERE, FLAG_MIXED_ATTACKER), 
    LEVEL_UP_TYPE_MOVE(39, MOVE_SUBMISSION, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(45, MOVE_CALM_MIND, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(45, MOVE_BULK_UP, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(51, MOVE_FOCUS_BLAST, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(50, MOVE_CROSS_CHOP, FLAG_HAS_HANDS),
    LEVEL_UP_TYPE_MOVE(50, MOVE_HI_JUMP_KICK, FLAG_HAS_FEET),
    LEVEL_UP_TYPE_MOVE(52, MOVE_SUPERPOWER, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(58, MOVE_CLOSE_COMBAT, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

/*
    LEVEL_UP_TYPE_MOVE(27, MOVE_MIRROR_MOVE),
    LEVEL_UP_TYPE_MOVE(33, MOVE_DRILL_PECK),
    LEVEL_UP_TYPE_MOVE(37, MOVE_AIR_SLASH),
    LEVEL_UP_TYPE_MOVE(41, MOVE_ROOST),
    LEVEL_UP_TYPE_MOVE(45, MOVE_AGILITY),
    LEVEL_UP_TYPE_MOVE(50, MOVE_BRAVE_BIRD),
    LEVEL_UP_TYPE_MOVE(56, MOVE_AEROBLAST),
    LEVEL_UP_TYPE_MOVE(65, MOVE_SKY_ATTACK),
    Leaf storm and twister for special attackers? uturn?
*/

static const u32 sFlyingTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(4, MOVE_PECK, FLAG_PHYSICAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(5, MOVE_GUST, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(9, MOVE_QUICK_ATTACK, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(13, MOVE_FEATHER_DANCE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(16, MOVE_WING_ATTACK, FLAG_PHYSICAL_ATTACKER | FLAG_HAS_WINGS),
    LEVEL_UP_TYPE_MOVE(16, MOVE_AIR_CUTTER, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(17, MOVE_AERIAL_ACE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

/*
    LEVEL_UP_TYPE_MOVE(32, MOVE_ACID_ARMOR),
    LEVEL_UP_TYPE_MOVE(40, MOVE_TOXIC),
    LEVEL_UP_TYPE_MOVE(43, MOVE_SLUDGE_BOMB),
    LEVEL_UP_TYPE_MOVE(46, MOVE_POISON_JAB),
    LEVEL_UP_TYPE_MOVE(51, MOVE_CROSS_POISON),
    LEVEL_UP_TYPE_MOVE(60, MOVE_GUNK_SHOT),
*/

static const u32 sPoisonTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(3, MOVE_POISON_STING, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(8, MOVE_ACID, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(12, MOVE_POISON_POWDER, FLAG_IS_ABILITY_1 | FLAG_IS_ABILITY_3),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(17, MOVE_POISON_GAS, FLAG_IS_ABILITY_1),
    LEVEL_UP_TYPE_MOVE(14, MOVE_SMOG, FLAG_IS_ABILITY_2),
    LEVEL_UP_TYPE_MOVE(14, MOVE_SMOKESCREEN, FLAG_IS_ABILITY_3),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(23, MOVE_SLUDGE, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(24, MOVE_POISON_FANG, FLAG_HAS_FANGS),
    LEVEL_UP_TYPE_MOVE(25, MOVE_POISON_TAIL, FLAG_HAS_TAIL),
    LEVEL_UP_TYPE_MOVE(23, MOVE_SLUDGE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};
...
/*
    MuddyWater?
    LEVEL_UP_TYPE_MOVE(24, MOVE_SANDSTORM),
    LEVEL_UP_TYPE_MOVE(29, MOVE_MUD_BOMB),
    LEVEL_UP_TYPE_MOVE(34, MOVE_BONE_CLUB),
    LEVEL_UP_TYPE_MOVE(38, MOVE_BARRIER),
    LEVEL_UP_TYPE_MOVE(42, MOVE_EARTHQUAKE),
    LEVEL_UP_TYPE_MOVE(46, MOVE_EARTH_POWER),
    LEVEL_UP_TYPE_MOVE(54, MOVE_FISSURE),
    LEVEL_UP_TYPE_END
*/

static const u32 sGroundTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_MUD_SLAP, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(9, MOVE_SAND_TOMB, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(14, MOVE_SANDSTORM, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(17, MOVE_MUD_SHOT, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(18, MOVE_DIG, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(28, MOVE_SPIKES, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(28, MOVE_WHIRLWIND, FLAG_HAS_WINGS),
    LEVEL_UP_TYPE_MOVE(28, MOVE_ROAR, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sRockTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(8, MOVE_ROCK_THROW, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(10, MOVE_ROCK_POLISH, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sBugTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_LEECH_LIFE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sGhostTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(3, MOVE_LICK, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sSteelTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(7, MOVE_METAL_CLAW, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sMysteryTypeLevelUpLearnset[] = { // this is used when no type change has occured
    LEVEL_UP_TYPE_MOVE(5, MOVE_QUICK_ATTACK, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sFireTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_EMBER, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sWaterTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(4, MOVE_BUBBLE, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(7, MOVE_AQUA_JET, FLAG_PHYSICAL_ATTACKER | FLAG_IS_LIGHT),
    LEVEL_UP_TYPE_MOVE(7, MOVE_BUBBLE_BEAM, FLAG_MIXED_ATTACKER),
    LEVEL_UP_TYPE_MOVE(6, MOVE_WATER_GUN, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sGrassTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(4, MOVE_ABSORB, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(9, MOVE_VINE_WHIP, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sElectricTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_QUICK_ATTACK, FLAG_PHYSICAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(5, MOVE_THUNDER_SHOCK, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_MOVE(9, MOVE_THUNDER_SHOCK, FLAG_PHYSICAL_ATTACKER),
    LEVEL_UP_TYPE_MOVE(9, MOVE_QUICK_ATTACK, FLAG_MIXED_ATTACKER),
    LEVEL_UP_TYPE_MOVE(9, MOVE_CHARGE, FLAG_SPECIAL_ATTACKER),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sPsychicTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(7, MOVE_CONFUSION, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sIceTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_POWDER_SNOW, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sDragonTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_TWISTER, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};

static const u32 sDarkTypeLevelUpLearnset[] = {
    LEVEL_UP_TYPE_MOVE(5, MOVE_THIEF, FLAG_ALL_CAN_LEARN),
    LEVEL_UP_TYPE_INTERNAL_END,
    LEVEL_UP_TYPE_END,
};
