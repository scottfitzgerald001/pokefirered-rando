...
const u8 gTrainerBackPic_Red[] = INCBIN_U8("graphics/trainers/back_pics/oak_back_pic.4bpp");
...
const u32 gTrainerPalette_RedBackPic[] = INCBIN_U32("graphics/trainers/palettes/oak_back.gbapal.lz");
