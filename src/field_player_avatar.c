...
static const u8 sPlayerAvatarGfxIds[][GENDER_COUNT] = {
    [PLAYER_AVATAR_GFX_NORMAL]     = {OBJ_EVENT_GFX_PROF_OAK,       OBJ_EVENT_GFX_GREEN_NORMAL},  // considering making oak the protaganist 
    [PLAYER_AVATAR_GFX_BIKE]       = {OBJ_EVENT_GFX_PROF_OAK_BIKE,  OBJ_EVENT_GFX_GREEN_BIKE},
...
static const u8 sPlayerAvatarGfxToStateFlag[][3][GENDER_COUNT] = {
    [MALE] = {
        {OBJ_EVENT_GFX_PROF_OAK,        PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_PROF_OAK_BIKE,   PLAYER_AVATAR_FLAG_MACH_BIKE},
