...
const u8 gMoveDescription_UTurn[] = _("After attacking the\nuser rushes back to\nswitch places with\na party Pokémon.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_SHADOW_CLAW   - 1] = gMoveDescription_QuickAttack,
    [MOVE_GIGA_IMPACT   - 1] = gMoveDescription_QuickAttack,
    [MOVE_AIR_SLASH     - 1] = gMoveDescription_QuickAttack,
    [MOVE_X_SCISSOR     - 1] = gMoveDescription_QuickAttack,
    [MOVE_ROOST         - 1] = gMoveDescription_QuickAttack,
    [MOVE_BRAVE_BIRD    - 1] = gMoveDescription_QuickAttack,
    [MOVE_AURA_SPHERE   - 1] = gMoveDescription_QuickAttack,
    [MOVE_CHARGE_BEAM   - 1] = gMoveDescription_QuickAttack,
    [MOVE_AQUA_RING     - 1] = gMoveDescription_QuickAttack,
    [MOVE_AQUA_TAIL     - 1] = gMoveDescription_QuickAttack,
    [MOVE_BUG_BUZZ      - 1] = gMoveDescription_QuickAttack,
    [MOVE_CLOSE_COMBAT  - 1] = gMoveDescription_QuickAttack,
    [MOVE_AVALANCHE     - 1] = gMoveDescription_QuickAttack,
    [MOVE_CROSS_POISON  - 1] = gMoveDescription_QuickAttack,
    [MOVE_DARK_PULSE    - 1] = gMoveDescription_QuickAttack,
    [MOVE_DISCHARGE     - 1] = gMoveDescription_QuickAttack,
    [MOVE_DRACO_METEOR  - 1] = gMoveDescription_QuickAttack,
    [MOVE_DRAGON_PULSE  - 1] = gMoveDescription_QuickAttack,
    [MOVE_DRAGON_RUSH   - 1] = gMoveDescription_QuickAttack,
    [MOVE_DRAIN_PUNCH   - 1] = gMoveDescription_QuickAttack,
    [MOVE_EARTH_POWER   - 1] = gMoveDescription_QuickAttack,
    [MOVE_ENERGY_BALL   - 1] = gMoveDescription_QuickAttack,
    [MOVE_FLARE_BLITZ   - 1] = gMoveDescription_QuickAttack,
    [MOVE_FLASH_CANNON  - 1] = gMoveDescription_QuickAttack,
    [MOVE_FOCUS_BLAST   - 1] = gMoveDescription_QuickAttack,
    [MOVE_FORCE_PALM    - 1] = gMoveDescription_QuickAttack,
    [MOVE_GRASS_KNOT    - 1] = gMoveDescription_QuickAttack,
    [MOVE_GUNK_SHOT     - 1] = gMoveDescription_QuickAttack,
    [MOVE_HAMMER_ARM    - 1] = gMoveDescription_QuickAttack,
    [MOVE_HEAD_SMASH    - 1] = gMoveDescription_QuickAttack,
    [MOVE_IRON_HEAD     - 1] = gMoveDescription_QuickAttack,
    [MOVE_LAVA_PLUME    - 1] = gMoveDescription_QuickAttack,
    [MOVE_LEAF_STORM    - 1] = gMoveDescription_QuickAttack,
    [MOVE_MAGNET_BOMB   - 1] = gMoveDescription_QuickAttack,
    [MOVE_MIRROR_SHOT   - 1] = gMoveDescription_QuickAttack,
    [MOVE_MUD_BOMB      - 1] = gMoveDescription_QuickAttack,
    [MOVE_NASTY_PLOT    - 1] = gMoveDescription_QuickAttack,
    [MOVE_NIGHT_SLASH   - 1] = gMoveDescription_QuickAttack,
    [MOVE_OMINOUS_WIND  - 1] = gMoveDescription_QuickAttack,
    [MOVE_PAYBACK       - 1] = gMoveDescription_QuickAttack,
    [MOVE_POISON_JAB    - 1] = gMoveDescription_QuickAttack,
    [MOVE_POWER_GEM     - 1] = gMoveDescription_QuickAttack,
    [MOVE_POWER_WHIP    - 1] = gMoveDescription_QuickAttack,
    [MOVE_PSYCHO_CUT    - 1] = gMoveDescription_QuickAttack,
    [MOVE_ROCK_POLISH   - 1] = gMoveDescription_QuickAttack,
    [MOVE_ROCK_WRECKER  - 1] = gMoveDescription_QuickAttack,
    [MOVE_SEED_BOMB     - 1] = gMoveDescription_QuickAttack,
    [MOVE_STONE_EDGE    - 1] = gMoveDescription_QuickAttack,
    [MOVE_WOOD_HAMMER   - 1] = gMoveDescription_QuickAttack,
    [MOVE_ZEN_HEADBUTT  - 1] = gMoveDescription_QuickAttack,
};
