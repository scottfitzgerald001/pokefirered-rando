...
#define MAPSEC_VIRIDIAN_RESERVE             0x8F

#define MAPSECS_SEVII_123                   0x9F

#define MAPSEC_ONE_ISLAND                   0x9F
#define MAPSEC_TWO_ISLAND                   0xA0
#define MAPSEC_THREE_ISLAND                 0xA1
#define MAPSEC_FOUR_ISLAND                  0xA2
#define MAPSEC_FIVE_ISLAND                  0xA3
#define MAPSEC_SEVEN_ISLAND                 0xA4
#define MAPSEC_SIX_ISLAND                   0xA5
#define MAPSEC_KINDLE_ROAD                  0xA6
#define MAPSEC_TREASURE_BEACH               0xA7
#define MAPSEC_CAPE_BRINK                   0xA8
#define MAPSEC_BOND_BRIDGE                  0xA9
#define MAPSEC_THREE_ISLE_PORT              0xAA
#define MAPSEC_SEVII_ISLE_6                 0xAB
#define MAPSEC_SEVII_ISLE_7                 0xAC
#define MAPSEC_SEVII_ISLE_8                 0xAD
#define MAPSEC_SEVII_ISLE_9                 0xAE
#define MAPSEC_RESORT_GORGEOUS              0xAF
#define MAPSEC_WATER_LABYRINTH              0xB0
#define MAPSEC_FIVE_ISLE_MEADOW             0xB1
#define MAPSEC_MEMORIAL_PILLAR              0xB2
#define MAPSEC_OUTCAST_ISLAND               0xB3
#define MAPSEC_GREEN_PATH                   0xB4
#define MAPSEC_WATER_PATH                   0xB5
#define MAPSEC_RUIN_VALLEY                  0xB6
#define MAPSEC_TRAINER_TOWER                0xB7
#define MAPSEC_CANYON_ENTRANCE              0xB8
#define MAPSEC_SEVAULT_CANYON               0xB9
#define MAPSEC_TANOBY_RUINS                 0xBA
#define MAPSEC_SEVII_ISLE_22                0xBB
#define MAPSEC_SEVII_ISLE_23                0xBC
#define MAPSEC_SEVII_ISLE_24                0xBD
#define MAPSEC_NAVEL_ROCK                   0xBE
#define MAPSEC_MT_EMBER                     0xBF
#define MAPSEC_BERRY_FOREST                 0xC0
#define MAPSEC_ICEFALL_CAVE                 0xC1
#define MAPSEC_ROCKET_WAREHOUSE             0xC2
#define MAPSEC_TRAINER_TOWER_2              0xC3
#define MAPSEC_DOTTED_HOLE                  0xC4
#define MAPSEC_LOST_CAVE                    0xC5
#define MAPSEC_PATTERN_BUSH                 0xC6
#define MAPSEC_ALTERING_CAVE                0xC7
#define MAPSEC_TANOBY_CHAMBERS              0xC8
#define MAPSEC_THREE_ISLE_PATH              0xC9
#define MAPSEC_TANOBY_KEY                   0xCA
#define MAPSEC_BIRTH_ISLAND                 0xCB
#define MAPSEC_MONEAN_CHAMBER               0xCC
#define MAPSEC_LIPTOO_CHAMBER               0xCD
#define MAPSEC_WEEPTH_CHAMBER               0xCE
#define MAPSEC_DILFORD_CHAMBER              0xCF
#define MAPSEC_SCUFIB_CHAMBER               0xD0
#define MAPSEC_RIXY_CHAMBER                 0xD1
#define MAPSEC_VIAPOIS_CHAMBER              0xD2
#define MAPSEC_EMBER_SPA                    0xD3
#define MAPSEC_SPECIAL_AREA                 0xD4
